      ...
      <div className="w-full max-w-2xl">
        <div className="card">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">{summary.sessionName}</p>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  ...
                  <th className="text-left py-2 px-3 text-sm font-semibold text-gray-700">Story</th>
                  <th className="text-right py-2 px-3 text-sm font-semibold text-gray-700">Points</th>
                </tr>
              </thead>
              <tbody>
                {summary.stories.map((story, index) => (
                  <tr key={index} className="border-b border-gray-100">
                    ...
                    <td className="py-3 px-3 font-medium text-gray-900">{story.title}</td>
                    <td className="py-3 px-3 text-right">
                      {story.finalPoints ? (
                        <span className="inline-flex items-center justify-center w-10 h-8 bg-green-100 text-green-700 font-bold rounded">
                          {story.finalPoints}
                        </span>
                      ) : (
              ...
              <tfoot>
                <tr className="border-t-2 border-gray-200 bg-gray-50">
                  <td colSpan={2} className="py-3 px-3 font-semibold text-gray-700">Total</td>
                  <td className="py-3 px-3 text-right">
                    <span className="inline-flex items-center justify-center px-3 h-8 bg-primary-100 text-primary-700 font-bold rounded">
          ...
          {/* Meta Info */}
          <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-6 p-4 bg-gray-50 rounded-lg">
            <div>
